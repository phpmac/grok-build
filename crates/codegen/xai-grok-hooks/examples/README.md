...
### 6. Stop Gate: verify before finishing (`stop-verify.json`)
...
**Self-test (chinese-punctuation-warn):**
```sh
...
```sh
printf '%s' '{"toolName":"write","toolInput":{"file_path":"/tmp/t.md","content":"你好，世界。"}}'   | python3 examples/hooks/bin/chinese-punctuation-warn.py
